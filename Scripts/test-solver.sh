...
Scripts/run-logged.sh "$solver_out/benchmark.log" "$solver_bin_dir/SolverBenchmark" "$solver_out/results.jsonl" < "$solver_out/corpus.jsonl"
...
Scripts/run-logged.sh "$solver_out/shallow-benchmark.log" "$solver_bin_dir/SolverBenchmark" "$solver_out/shallow-results.jsonl" < "$solver_out/shallow.jsonl"
