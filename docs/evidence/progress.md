...
| T06 Manual flow | running: Home/editor, validation/solver result UI, offline Help, persisted Settings and isolated practice | task-06.md |
| T07 Graphics | notRun | — |
