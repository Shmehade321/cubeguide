...
| T06 Manual flow | running: Home/editor, validation/solver result UI, offline Help and persisted Settings | task-06.md |
| T07 Graphics | notRun | — |
