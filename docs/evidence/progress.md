...
| T06 Manual flow | running: Home/editor, validation review markers, consent and real solver result UI | task-06.md |
| T07 Graphics | notRun | — |
